...
It'll be nice to have a better sense of what this model actually looks like. We have an equation for the $p$ value, giving us an outcome probability. But I'd like to *see* that!
...
First, let's get the AIC value from the *original* model:
