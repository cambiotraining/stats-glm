...
Back in the [aphids exercise](@sec-exr_aphids), we fitted a logistic model to the `aphids` dataset - the code is included below in case you need to run it again.
